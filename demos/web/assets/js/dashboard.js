...
function starttimeXnum(min, visitors) {
	...
	visitors.forEach( (x) => {
		let earliest = engagement[x][0],
		latest = engagement[x][engagement[x].length];
		engagement[x] = Math.ceil((latest.getTime() - earliest.getTime()) / (1000 * timeStep_engagement));
